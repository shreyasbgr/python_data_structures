...
print('0th node from behind:')
print(my_linked_list.find_kth_from_end(0).value)


print('1st node from behind:')
print(my_linked_list.find_kth_from_end(1).value)

print("5th node from behind:")
print(my_linked_list.find_kth_from_end(5).value)
